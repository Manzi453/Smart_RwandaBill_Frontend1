...
export const QuickActionsPanel = () => {
  ...
  const handlePaymentComplete = (result: unknown) => {
    ...
    // Type checking if you need to access properties
    if (result && typeof result === 'object' && 'success' in result) {
      console.log('Payment success:', (result as { success: boolean }).success);
    }
  ...
  const handleSetReminder = () => {
    ...
    toast.success(`Payment reminder set to ${reminderFrequency}!`);
    setShowRemindersDialog(false);
  };

  const handleSchedulePayment = () => {
    console.log("Payment scheduled for:", scheduleFrequency);
    toast.success(`Recurring payment scheduled ${scheduleFrequency}!`);
  ...
  const actions: QuickAction[] = [
    {
      id: "pay-bill",
      title: t("payBill"),
      description: t("payBillDescription"),
    ...
    {
      id: "view-statements",
      title: t("viewStatements"),
      description: t("viewStatementsDescription"),
    ...
    },
    {
      ...
      description: t("setRemindersDescription"),
    ...
    },
    {
      ...
      description: t("downloadReceiptDescription"),
    ...
    },
    {
      ...
      description: t("schedulePaymentDescription"),
